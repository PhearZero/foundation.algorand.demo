...
package foundation.algorand.demo.GATT;
...
public class GattServerActivity extends Activity {
    ...
    private void checkPermission(String permission, int requestCode)
    {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.S) {
            Toast.makeText(GattServerActivity.this, "No permissions necessary", Toast.LENGTH_SHORT).show();
        } else {
            // Checking if permission is not granted
            if (ContextCompat.checkSelfPermission(GattServerActivity.this, permission) == PackageManager.PERMISSION_DENIED) {
                Toast.makeText(GattServerActivity.this, "Asking for permission", Toast.LENGTH_SHORT).show();
                ActivityCompat.requestPermissions(GattServerActivity.this, new String[] { permission }, requestCode);
            }
            else {
                Toast.makeText(GattServerActivity.this, "Permission already granted", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    private BluetoothGattServerCallback mGattServerCallback = new BluetoothGattServerCallback() {
        ...
        public void onDescriptorReadRequest(BluetoothDevice device, int requestId, int offset,
            ...
            if (TimeProfile.CLIENT_CONFIG.equals(descriptor.getUuid())) {
                ...
                if (ActivityCompat.checkSelfPermission(GattServerActivity.this, Manifest.permission.BLUETOOTH_CONNECT) != PackageManager.PERMISSION_GRANTED) {
